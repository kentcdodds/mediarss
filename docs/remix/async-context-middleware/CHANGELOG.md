...
[`async-context-middleware`](https://github.com/remix-run/remix/tree/main/packages/async-context-middleware).
...
- `getContext()` can now be typed per app by augmenting `AsyncContextTypes`,
  which makes `asyncContext()` work cleanly with app-specific `fetch-router`
...
See the
[README](https://github.com/remix-run/remix/blob/main/packages/async-context-middleware/README.md)
for more details.
