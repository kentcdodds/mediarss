...
[`compression-middleware`](https://github.com/remix-run/remix/tree/main/packages/compression-middleware).
...
See the
[README](https://github.com/remix-run/remix/blob/main/packages/compression-middleware/README.md)
for more details.
