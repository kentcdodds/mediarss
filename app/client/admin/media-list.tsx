										...
										return (
											<tr
												...
												mix={[
													...
													rmxOn<HTMLTableRowElement, 'click'>(
														'click',
														(event: MouseEvent) => {
			...
			>
				<button
					...
					mix={[
						...
						rmxOn('click', () => onPageChange(currentPage - 1)),
					]}
				>
					← Previous
				</button>
							...
							<button
								...
								mix={[
									rmxCss({
										...
										color:
											page === currentPage ? colors.background : colors.text,
										backgroundColor:
